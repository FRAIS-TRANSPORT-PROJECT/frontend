...
const DemandePage = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8086/api/v1/demandes/' + id, {
        headers: {
    ...
    axios
      .get('http://localhost:8086/api/v1/demandes/' + id + '/documents', {
        headers: {
          Authorization: `Basic ${user}`,
          'Content-Type': 'application/json'
        }
  ...
  const changeEtat = (id, justif, currentEtat) => {
    ...
    axios
      .patch('http://localhost:8086/api/v1/demandes/' + id, demandeData, {
        headers: {
          Authorization: `Basic ${user}`,
          'Content-Type': 'application/json'
        }
